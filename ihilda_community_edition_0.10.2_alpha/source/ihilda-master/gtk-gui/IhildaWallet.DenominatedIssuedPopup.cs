...
{
	public partial class DenominatedIssuedPopup
	{
		...
		protected virtual void Build()
		{
			...
			// Widget IhildaWallet.DenominatedIssuedPopup
			this.Name = "IhildaWallet.DenominatedIssuedPopup";
			this.WindowPosition = ((global::Gtk.WindowPosition)(2));
			this.Modal = true;
			// Internal child IhildaWallet.DenominatedIssuedPopup.VBox
			...
			w5.Position = 0;
			// Internal child IhildaWallet.DenominatedIssuedPopup.ActionArea

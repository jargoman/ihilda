...
#pragma warning disable RECS0122 // Initializing field with default value is redundant
		...
		{
			String method_sig = clsstr + nameof (SetDebug) + DebugRippleLibSharp.left_parentheses + (value ?? "null") + DebugRippleLibSharp.right_parentheses;
...
#pragma warning restore IDE0020 // Use pattern matching
		...
		public static string AssertAllowInsecure ( object o ) {
			...
			if (o is RippleSeedAddress) {
				...
				return DebugIhildaWallet.allowInsecureDebugging ? rs.ToString () : rs.ToHiddenString ();

			}



			if (!DebugIhildaWallet.allowInsecureDebugging) {

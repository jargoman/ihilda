...
{
	public partial class AccountLinesWidget
	{
		...
		protected virtual void Build()
		{
			...
			// Widget IhildaWallet.AccountLinesWidget
			global::Stetic.BinContainer.Attach(this);
			this.Name = "IhildaWallet.AccountLinesWidget";
			// Container child IhildaWallet.AccountLinesWidget.Gtk.Container+ContainerChild
			...
			this.infoBarLabel.LabelProp = global::Mono.Unix.Catalog.GetString("<span fgcolor=\"red\">This is an info bar</span>");
			this.infoBarLabel.UseMarkup = true;
			this.vbox1.Add(this.infoBarLabel);
			global::Gtk.Box.BoxChild w7 = ((global::Gtk.Box.BoxChild)(this.vbox1[this.infoBarLabel]));
			w7.Position = 3;
			w7.Expand = false;
			w7.Fill = false;
			// Container child vbox1.Gtk.Box+BoxChild

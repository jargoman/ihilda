...
{
	public partial class SignOptionsDialog
	{
		...
		protected virtual void Build()
		{
			...
			// Widget IhildaWallet.SignOptionsDialog
			this.Name = "IhildaWallet.SignOptionsDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child IhildaWallet.SignOptionsDialog.VBox
			...
			this.label2.LabelProp = global::Mono.Unix.Catalog.GetString("To continue you must have a valid sign option configuration");
			...
			w4.Expand = false;
			w4.Fill = false;
			// Internal child IhildaWallet.SignOptionsDialog.ActionArea

...
namespace IhildaWallet
{
	public class ProfitStrategy
	{
		...
		public ProfitStrategy ( Decimal pay_less, Decimal get_more, Decimal speculate)
		{
			this.Pay_Less = pay_less;
			this.Get_More = get_more;
		...
		public Decimal Exp_Pay_Less {
			get;
			set;
		}

		public Decimal Exp_Get_More {
			get;
			set;
		}

		public Decimal Speculate {
			get;
			set;
		}

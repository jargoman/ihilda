...
namespace IhildaWallet
{
	public partial class RandomSeedGenerator
	{
		...
		protected virtual void Build()
		{
			...
			// Widget IhildaWallet.RandomSeedGenerator
			this.Name = "IhildaWallet.RandomSeedGenerator";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child IhildaWallet.RandomSeedGenerator.VBox
			...
			this.label1.LabelProp = global::Mono.Unix.Catalog.GetString("Enter an alpha-numeric phrase of minimum 10 characters to use as a salt for the s" +
					"eed generation");
			...
			w10.Position = 0;
			// Internal child IhildaWallet.RandomSeedGenerator.ActionArea
